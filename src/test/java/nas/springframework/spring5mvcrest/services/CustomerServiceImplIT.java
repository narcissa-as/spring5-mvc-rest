...
import nas.springframework.spring5mvcrest.bootstrap.Bootstrap;
...
@DataJpaTest // brings up a smaller set of spring boot context where it sets up the data layer and gets
// an in-memory database through H2 and Spring Data Repository become Spring managed components
